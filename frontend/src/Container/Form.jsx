       ...
       <div className='mt-8'>
        ...
        <div>
            ...
            <div className='mt-8 flex flex-col gap-y-4'>
                <button className=' active:scale-[.98] active:duration-75 transition-all hover:scale-[1.05] ease-in-out p-3 rounded-3xl bg-violet-500 text-white text-lg font-bold'>Sign in</button>
