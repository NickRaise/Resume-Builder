...
<div className='flex mb-5 items-center justify-center '><img src={Logo} width={100} height={120} alt="" /></div>
       ...
       <p className='font-medium text-lg text-gray-500 mt-4'>Start finding right resume foy you today!</p>
       <div className='mt-8'>
       <div>
        ...
        <div>
            ...
            <input className='w-full border-2 border-gray-100 rounded-xl p-4 mt-1 bg-transparent' placeholder='Create password' />
        </div>

           
            <div className='mt-8 flex flex-col gap-y-4'>
                <button className=' active:scale-[.98] active:duration-75 transition-all hover:scale-[1.05] ease-in-out p-3 rounded-3xl bg-violet-500 text-white text-lg font-bold'>Sign up</button>
                <span className='flex items-center justify-center font-medium text-base'>--------------------OR--------------------</span>
            ...
            <div className='mt-8 flex gap-2 justify-center items-center'>
                ...
                <button className='text-violet-500 text-base font-medium'><Link to="/Auth">login</Link></button>
            </div>
       </div>
    </div>
    </div>
